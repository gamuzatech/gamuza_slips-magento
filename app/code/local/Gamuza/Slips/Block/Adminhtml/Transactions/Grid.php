...
extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		...
		"header" => Mage::helper("slips")->__("ID"),
		"align" =>"right",
		"width" => "50px",
		"index" => "id",
		));
		$this->addColumn("order_id", array(
		"header" => Mage::helper("slips")->__("Order ID"),
		"align" =>"left",
		"width" => "50px",
		"index" => "order_id",
		));
		$this->addColumn("order_increment_id", array(
		"header" => Mage::helper("slips")->__("Order Increment ID"),
		"align" =>"left",
		"index" => "increment_id",
		));
		$this->addColumn("number", array(
		"header" => Mage::helper("slips")->__("Number"),
		"align" =>"left",
		"index" => "number",
		));
		$this->addColumn("expiration", array(
		"header" => Mage::helper("slips")->__("Expiration"),
		"align" => "right",
		"index" => "expiration",
		"type" => "date",
		...
		"header" => Mage::helper("slips")->__("Amount"),
		"align" =>"right",
		"index" => "amount",
		"type" => "currency",
