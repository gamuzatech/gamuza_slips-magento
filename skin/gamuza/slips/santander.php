...
$dadosboleto["nosso_numero"] = $_POST ['number']; // "1234567";  // Nosso numero sem o DV - REGRA: Máximo de 7 caracteres!
$dadosboleto["numero_documento"] = $_POST ['order_id']; // "12345";	// Num do pedido ou nosso numero
...
$dadosboleto["codigo_cliente"] = $_POST ['client_code']; // "0707077"; // Código do Cliente (PSK) (Somente 7 digitos)
$dadosboleto["ponto_venda"] = $_POST ['outlet']; // "1333"; // Ponto de Venda = Agencia
$dadosboleto["carteira"] = $_POST ['portfolio']; // "102";  // Cobrança Simples - SEM Registro
$dadosboleto["carteira_descricao"] = $_POST ['portfolio_description']; // "COBRANÇA SIMPLES - CSR";  // Descrição da Carteira
