...
$dadosboleto["nosso_numero"] = $_POST ['number']; // "0000000123456";  // Nosso numero - REGRA: Máximo de 13 caracteres!
$dadosboleto["numero_documento"] = $_POST ['order_id']; // "1234567";	// Num do pedido ou do documento
...
$dadosboleto["agencia"] = $_POST ['agency']; // "1234"; // Num da agencia, sem digito
$dadosboleto["conta"] = $_POST ['account']; // "0012345"; 	// Num da conta, sem digito
$dadosboleto["carteira"] = $_POST ['portfolio']; // "57";  // Código da Carteira
