...
$dadosboleto["inicio_nosso_numero"] = $_POST ['prefix']; // "99";  // Inicio do Nosso numero -> 99 - Cobrança Direta(Carteira 5) ou 0 - Cobrança Simples(Carteira 1)
$dadosboleto["nosso_numero"] = $_POST ['number']; // "0000020";  // Nosso numero sem o DV - REGRA: Máximo de 7 caracteres!
...
$dadosboleto["agencia"] = $_POST ['agency']; // "0033"; // Num da agencia, sem digito
$dadosboleto["conta_cedente"] = $_POST ['transferor_account']; // "001131"; // ContaCedente do Cliente, sem digito (Somente 6 digitos)
$dadosboleto["conta_cedente_dv"] = $_POST ['transferor_account_dv']; // "1"; // Digito da ContaCedente do Cliente
$dadosboleto["carteira"] = $_POST ['portfolio']; // "5";  // Código da Carteira -> 5-Cobrança Direta ou 1-Cobrança Simples
$dadosboleto["modalidade_conta"] = $_POST ['modality_account']; // "04";  // modalidade da conta 02 posições
