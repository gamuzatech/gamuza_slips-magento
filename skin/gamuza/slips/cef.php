...
$dadosboleto["inicio_nosso_numero"] = $_POST ['prefix']; // "80";  // Carteira SR: 80, 81 ou 82  -  Carteira CR: 90 (Confirmar com gerente qual usar)
$dadosboleto["nosso_numero"] = $_POST ['number']; // "19525086";  // Nosso numero sem o DV - REGRA: Máximo de 8 caracteres!
...
$dadosboleto["quantidade"] = $_POST ['quantity']; // "";
$dadosboleto["valor_unitario"] = $_POST ['unitary_value']; // "";
$dadosboleto["aceite"] = $_POST ['acceptance']; // "";		
$dadosboleto["especie"] = $_POST ['specie']; // "R$";
$dadosboleto["especie_doc"] = $_POST ['specie_doc']; // "";
...
$dadosboleto["agencia"] = $_POST ['agency']; // "1565"; // Num da agencia, sem digito
$dadosboleto["conta"] = $_POST ['account']; // "13877"; 	// Num da conta, sem digito
$dadosboleto["conta_dv"] = $_POST ['account_dv']; // "4"; 	// Digito do Num da conta

// DADOS PERSONALIZADOS - CEF
$dadosboleto["conta_cedente"] = $_POST ['transferor_account']; // "87000000414"; // ContaCedente do Cliente, sem digito (Somente Números)
$dadosboleto["conta_cedente_dv"] = $_POST ['transferor_account_dv']; // "3"; // Digito da ContaCedente do Cliente
$dadosboleto["carteira"] = $_POST ['portfolio']; // "SR";  // Código da Carteira: pode ser SR (Sem Registro) ou CR (Com Registro) - (Confirmar com gerente qual usar)
