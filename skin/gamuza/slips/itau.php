...
$dadosboleto["nosso_numero"] = $_POST ['number']; // '12345678';  // Nosso numero - REGRA: Máximo de 8 caracteres!
$dadosboleto["numero_documento"] = $_POST ['order_id']; // '0123';	// Num do pedido ou nosso numero
...
$dadosboleto["codigo_cliente"] = $_POST ['client_code']; // "2031671"; // Codigo do Cliente (obsoleto)
$dadosboleto["carteira"] = $_POST ['portfolio']; // "175";  // Código da Carteira: pode ser 175, 174, 104, 109, 178, ou 157
