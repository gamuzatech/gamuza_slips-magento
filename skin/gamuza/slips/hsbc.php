...
$dadosboleto["numero_documento"] = $_POST ['number']; // "12345678";	// Número do documento - REGRA: Máximo de 13 digitos
...
$dadosboleto["codigo_cedente"] = $_POST ['tranferor_account']; // "1122334"; // Código do Cedente (Somente 7 digitos)
$dadosboleto["carteira"] = $_POST ['portfolio']; // "CNR";  // Código da Carteira
