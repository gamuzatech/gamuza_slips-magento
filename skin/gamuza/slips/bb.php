...
$dadosboleto["nosso_numero"] = $_POST ['number']; // "87654";
$dadosboleto["numero_documento"] = $_POST ['order_id']; // "27.030195.10";	// Num do pedido ou do documento
...
$dadosboleto["quantidade"] = $_POST ['quantity']; // "10";
$dadosboleto["valor_unitario"] = $_POST ['unitary_value']; // "10";
$dadosboleto["aceite"] = $_POST ['acceptance']; // "N";		
$dadosboleto["especie"] = $_POST ['specie']; // "R$";
$dadosboleto["especie_doc"] = $_POST ['specie_doc']; // "DM";
...
$dadosboleto["agencia"] = $_POST ['agency']; // "9999"; // Num da agencia, sem digito
$dadosboleto["conta"] = $_POST ['account']; // "99999"; 	// Num da conta, sem digito

// DADOS PERSONALIZADOS - BANCO DO BRASIL
$dadosboleto["convenio"] = $_POST ['agreement']; // "7777777";  // Num do convênio - REGRA: 6 ou 7 ou 8 dígitos
$dadosboleto["contrato"] = $_POST ['contract']; // "999999"; // Num do seu contrato
$dadosboleto["carteira"] = $_POST ['portfolio']; // "18";
$dadosboleto["variacao_carteira"] = $_POST ['portfolio_variation']; // "-019";  // Variação da Carteira, com traço (opcional)

// TIPO DO BOLETO
$dadosboleto["formatacao_convenio"] = $_POST ['agreement_formation']; // "7"; // REGRA: 8 p/ Convênio c/ 8 dígitos, 7 p/ Convênio c/ 7 dígitos, ou 6 se Convênio c/ 6 dígitos
$dadosboleto["formatacao_nosso_numero"] = $_POST ['number_formation']; // "2"; // REGRA: Usado apenas p/ Convênio c/ 6 dígitos: informe 1 se for NossoNúmero de até 5 dígitos ou 2 para opção de até 17 dígitos
