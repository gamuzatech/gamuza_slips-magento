...
$dadosboleto["nosso_numero"] = $_POST ['number']; // "1803029901";  // Nosso numero - REGRA: Máximo de 14 caracteres!
$dadosboleto["numero_documento"] = $_POST ['order_id']; // "18.030299.01";	// Num do pedido ou do documento
...
$dadosboleto["especie_doc"] = $_POST ['specie_dv']; // "DM";
...
$dadosboleto["agencia"] = $_POST ['agency']; // "0123"; // Num da agencia, sem digito
$dadosboleto["conta"] = $_POST ['account']; // "100618"; 	// Num da conta, sem digito
$dadosboleto["conta_dv"] = $_POST ['account_dv']; // "9"; 	// Digito do Num da conta

// DADOS PERSONALIZADOS - UNIBANCO
$dadosboleto["codigo_cliente"] = $_POST ['client_code']; // "2031671"; // Codigo do Cliente
$dadosboleto["carteira"] = $_POST ['portfolio']; // "20";  // Código da Carteira
